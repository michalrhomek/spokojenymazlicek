...
{/if}
	...
	<div class="table-responsive-row clearfix{if isset($use_overflow) && $use_overflow} overflow-y{/if}">
		<table{if $table_id} id="table-{$table_id}"{/if} class="table{if $table_dnd} tableDnD_GP{/if} {$table}" >
			<thead>
				<tr class="nodrag nodrop">
					...
					<th class="{if isset($params.class)}{$params.class}{/if}{if isset($params.align)} {$params.align}{/if}">
						<span class="title_box{if isset($order_by) && ($key == $order_by)} active{/if}">
							...
							{else}
								{$params.title}
							{/if}
							{if (!isset($params.orderby) || $params.orderby) && !$simple_header && isset($show_filters) && $show_filters}
					...
					{/if}
					{if $has_actions || (isset($show_filters) && $show_filters)}
						<th>{if !$simple_header}{/if}</th>
					{/if}
				</tr>
			{if !$simple_header && isset($show_filters) && $show_filters}
				<tr class="nodrag nodrop filter {if $row_hover}row_hover{/if}">
					...
					{if $has_actions || (isset($show_filters) && $show_filters)}
						<th class="actions">
							{if isset($show_filters) && $show_filters}
