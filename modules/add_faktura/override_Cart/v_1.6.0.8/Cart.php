...
*/
				...
				if ($with_taxes)
				{
					$tax_rate = Tax::getProductTaxRate((int)$product['id_product'], (int)$address_id);
					$total_price = Tools::ps_round($price * (1 + (float)$tax_rate / 100) * (int)$product['cart_quantity'], 2);
				}
