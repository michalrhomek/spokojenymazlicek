...
class Pms_GoPay_Extra_Questions extends Pms_GoPay_Extra_ModuleConfig
{
	...
	{
		return $this->l('Frequently Asked Questions', self::TABNAME);
	}
	...
	private function getForm()
	{
		$fields_form = array(
				'form' => array(
					'legend' => array(
						'title' => $this->l('Frequently Asked Questions', self::TABNAME),
						'icon' => $this->getIcon().'-circle'
					),
					'input' => array(
						array(
							'type' => 'hidden',
	...
	{
		return '<div id="questions-content"></div>';
	}
	...
	public function getQuestions()
	{
		...
		$iframe_url = 'https://prestamoduleshop.com/_checkFrame.php?psVersion='._PS_VERSION_.'&moduleName='.$this->_M->name.'&moduleVersion='.$this->_M->version.'&isoLang='.$iso_lang.'&parentUrl='.$parent_domain.'&getQuestionsFrame';
