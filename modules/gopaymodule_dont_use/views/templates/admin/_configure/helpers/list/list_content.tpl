			...
			{block name="td_content"}
				...
				{if isset($tr.$key)}
					...
					{elseif isset($params.activeVisu)}
						{if $tr.$key}
							<i class="icon-check-ok"></i> {l s='Enabled' mod='pms_gopay_extra'}
						{else}
							<i class="icon-remove"></i> {l s='Disabled' mod='pms_gopay_extra'}
						{/if}
...
*}
					{elseif isset($params.type) && $params.type == 'html'}{$tr.$key}
{*
* Edited by Miloslav  Kubín
*}
	...
	<tr>
		<td class="list-empty" colspan="{count($fields_display)+1}">
			<div class="list-empty-msg">
				...
				{l s='No records found' mod='pms_gopay_extra'}
			</div>
		</td>
	</tr>
{/if}
