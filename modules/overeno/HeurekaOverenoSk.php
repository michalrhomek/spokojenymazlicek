...
class HeurekaOverenoSk extends HeurekaOvereno{

  
    const BASE_URL = 'http://www.heureka.sk/direct/dotaznik/objednavka.php';
    ...
    public function __construct () {
        $this->apiKey = Configuration::get('HEUREKA_KEY_SK');
