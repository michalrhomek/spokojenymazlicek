<div class="opc-form-group">
    <div class="w100">
        <div class="opc-checkbox shaim_heureka_checkbox">
            <label for="shaim_heureka_checkbox">
                ...
                <span class="opc-text">{l s='Nesouhlasím se zasláním dotazníku spokojenosti v rámci programu Ověřeno zákazníky, který pomáhá zlepšovat vaše služby.' mod='shaim_heureka_cz_overeno'}</span>
            </label>
        </div>
    </div>
</div>
