...
$delivered
<" . $tag_prefix . ":payVAT>false</" . $tag_prefix . ":payVAT>
...
<typ:unitPrice>" . Tools::ps_round($product['unit_price_tax_excl'] * $other_conversion_rate, $pocet_desetinnych_mist) . "</typ:unitPrice>
<typ:price>" . Tools::ps_round($product['unit_price_tax_excl'] * $other_conversion_rate, $pocet_desetinnych_mist) . "</typ:price>
...
$invoice_only
<" . $tag_prefix . ":" . $currency_type . ">
<typ:unitPrice>" . Tools::ps_round((($invoices_orders == 'dobropisy') ? $orderslip->total_shipping_tax_excl : $order->total_shipping_tax_excl) * $other_conversion_rate, $pocet_desetinnych_mist) . "</typ:unitPrice>
<typ:price>" . Tools::ps_round((($invoices_orders == 'dobropisy') ? $orderslip->total_shipping_tax_excl : $order->total_shipping_tax_excl) * $other_conversion_rate, $pocet_desetinnych_mist) . "</typ:price>
...
<" . $tag_prefix . ":" . $currency_type . ">
<typ:unitPrice>-" . Tools::ps_round($discount['value_tax_excl'] * $other_conversion_rate, $pocet_desetinnych_mist) . "</typ:unitPrice>
<typ:price>-" . Tools::ps_round($discount['value_tax_excl'] * $other_conversion_rate, $pocet_desetinnych_mist) . "</typ:price>
...
<" . $tag_prefix . ":rateVAT>" . $this->TaxToVatRateTypePohoda((int)$order->carrier_tax_rate) . "</" . $tag_prefix . ":rateVAT>
<" . $tag_prefix . ":" . $currency_type . ">
<typ:unitPrice>" . Tools::ps_round($order->total_wrapping_tax_excl * $other_conversion_rate, $pocet_desetinnych_mist) . "</typ:unitPrice>
<typ:price>" . Tools::ps_round($order->total_wrapping_tax_excl * $other_conversion_rate, $pocet_desetinnych_mist) . "</typ:price>
    ...
    private function ModuleToPaymentPohoda($order, $carrier)
    {
        ...
        if ($module == 'universalpay') {
            ...
            if ($module == 'bankwire' || $module == 'add_bankwire' || $module == 'shaim_bankwire' || $module == 'pms_bankwire' || $module == 'dm_bankwire' || $module == 'bankwiremultiple' || $module == 'ps_wirepayment' || $module == 'add_pay_invoice' || $module == 'pms_pay_invoice') {
                ...
                $payment = 'cash';
            } elseif ($module == 'gopay' || $module == 'add_gopay' || $module == 'add_gopay_new' || $module == 'dm_gopay' || $module == 'shaim_gopay' || $module == 'pms_gopay_extra' || $module == 'ThePayBinder' || $module == 'thepay' || $module == 'AgmoBinder' || $module = 'BankwireFioBinder' || $module == 'ZaplacenoBinder' || $module == 'TwistoBinder' || $module == 'TrustPayBinder' || $module == 'PayUBinder' || $module == 'MallPayBinder' || $module == 'HomeCreditBinder' || $module == 'EssoxBinder' || $module == 'CofidisEsBinder' || $module == 'CetelemEsBinder' || $module == 'CofidisBinder' || $module == 'ThePayEetBinder' || $module == 'PaySecBinder' || $module == 'GoPayRedirBinder' || $module == 'GoPayEetBinder' || $module == 'CSPayBinder' || $module == 'CsobEetBinder' || $module == 'CofidisSkBinder' || $module == 'CofidisHuBinder' || $module == 'CetelemBinder' || $module == 'CCBillBinder' || $module == 'AgmoEetBinder' || preg_match("/Binder$/", $module) || $module == 'wepaybycard' || $module == 'PayeezyBinder' || $module == 'thepay' || $module == 'GPWebPayBinder' || $module == 'GoPayBinder' || $module == 'paypal' || $module == 'trustpay') {
                $payment = 'creditcard';
            } elseif ($this->debug) {
                echo $this->l('Neznámá platební metoda - ') . $module . PHP_EOL;
            }
