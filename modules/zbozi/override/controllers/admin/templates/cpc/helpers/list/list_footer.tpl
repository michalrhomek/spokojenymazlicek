...
<div class="row">
<input type='radio' name='exp_sel' {if $exp_sel == 0} checked="checked" {/if} value=0 /> Vše (<span style="color: red;">{$list_total} celkem</span>) &nbsp; |  &nbsp;  
<input type='radio' name='exp_sel'   {if $exp_sel == 1} checked="checked" {/if} value=1  /> Jen vybrané zde &nbsp;  &nbsp;  &nbsp;  &nbsp;    &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; desetinny oddělené čárkou <br />
Heureka CPC: <input type ='text' name ='heureka_cpc'  size=10  style='width:100px;display:inline' value='{$heureka_cpc}' />  |
Zboží CPC: <input type ='text' name ='max_cpc'   size=10  style='width:100px;display:inline' value='{$max_cpc}' />  |
Zboží CPC Search: <input type ='text' name ='max_cpc_search'    size=10  style='width:100px;display:inline' value='{$max_cpc_search}' />
 
 
<input type='submit' name = 'cmd_cpc' value='{l s='Nastavit CPC'}' />
</div>
<div class="row">
	<div class="col-lg-6">
