...
<ul id="header_links">
	...
	<li id="header_link_tips"><a href="http://spokojeny-mazlicek.cz/content/6-tipy-a-rady" title="{l s='tipy a rady' mod='blockpermanentlinks'}">{l s='tipy a rady' mod='blockpermanentlinks'}</a></li>
