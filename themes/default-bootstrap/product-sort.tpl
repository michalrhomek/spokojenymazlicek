...
<ul class="display hidden-xs">
	<li class="display-title">{l s=''}</li>
    <li id="grid"><a rel="nofollow" href="#" title="{l s=''}"><i class="icon-th-large"></i>{l s=''}</a></li>
    <li id="list"><a rel="nofollow" href="#" title="{l s=''}"><i class="icon-th-list"></i>{l s=''}</a></li>
</ul>
